...
export class TrackingResultSevice {
  ...
  private convertMinutesToString(value: number) {
    ...
    const hours: any = Math.floor(sec / 3600) // get hours
    const minutes: any = Math.floor((sec - hours * 3600) / 60) // get minutes
    // const seconds: any = sec - hours * 3600 - minutes * 60 //  get seconds
    // if (hours < 10) {
    //   hours = '0' + hours
    // }
    // if (minutes < 10) {
