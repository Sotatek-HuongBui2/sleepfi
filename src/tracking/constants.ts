...
export const LUCKY_BOX_DATA = {
  level1: {
    openingBasicCost: '13.4',
    waitingTimeMinutes: 2880,
    speedUpCost: '0.0047',
    redrawRate: '0.025'
  },
  level2: {
    openingBasicCost: '18.8',
    waitingTimeMinutes: 4320,
    speedUpCost: '0.0044',
    redrawRate: '0.05'
  }
}
...
export const PERCENT_LOSE_BED = [
  { type: BED_QUALITY.COMMON, percent: 10 },
  { type: BED_QUALITY.UNCOMMON, percent: 7 },
